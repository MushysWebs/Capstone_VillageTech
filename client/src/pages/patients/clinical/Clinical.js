...
const Clinical = () => {
  ...
  // Fetch clinical data for the selected patient
  ...
  // Fetch treatments from SOC table
  ...
  // Fetch owner information for the patient
  ...
  return (
    <div className="patient-main">
      ...
      <div className="clinical-content">
        {/* CANINE CLINICAL RECORD - all clinical-related data */}
        <div className="section-box">
          <h2 className="section-header">CANINE CLINICAL RECORD</h2>
          <div className="info-grid">
            ...
            <div className="info-item">
              ...
              <div className="info-value">{ownerInfo?.name || "N/A"}</div>
            </div>
            ...
            <div className="info-item">
              ...
              {isEditing ? (
                <input
                  type="text"
                  name="comments"
                  value={clinicalData?.comments || ""}
                  onChange={handleInputChange}
                />
              ) : (
                <div className="info-value">{clinicalData?.comments || "N/A"}</div>
              )}
            </div>
          </div>
          ...
          <div className="info-grid">
            {treatments.map((treatment) => (
              <div key={treatment.id} className="info-item">
                ...
                <div className="info-value">Event: {treatment.event_name}, Notes: {treatment.comments}</div>
              </div>
            ))}
          </div>
        </div>
